 ...
 * @brief Compressor::computeCrossSums -- compute cross-sum families and fill the payload.
 *
 * B.57: 2 uniform-127 LTP partition sums (LTP1SM, LTP2SM).
 */
...
namespace crsce::compress {
     ...
     * @brief Compute row, column, diagonal, anti-diagonal, and 2 LTP partition sums from the CSM.
     * @param csm The populated cross-sum matrix.
     * @param payload The CompressedPayload to fill with LSM, VSM, DSM, XSM, LTP1SM, LTP2SM.
     * @return void
     * @throws None
     */
