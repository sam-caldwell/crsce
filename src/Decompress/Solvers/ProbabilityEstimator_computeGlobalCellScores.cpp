...
namespace crsce::decompress::solvers {
     ...
     *
     * Iterates every row, scoring each unassigned cell using non-row line residuals
     * (col, diag, anti-diag, and 1-2 LTP lines per B.21). Returns all cells sorted
     * by confidence descending so the global DFS assigns most-constrained cells first.
     *
