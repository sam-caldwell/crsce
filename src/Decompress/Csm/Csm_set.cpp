...
namespace crsce::decompress {
    /**
     * @name set
     * @brief set a value at (r,c)
     * @param r row
     * @param c column
     * @param lock mutex log
     * @return void
     */
    void Csm::set(const std::size_t r, const std::size_t c, const MuLockFlag lock) {
        bounds_check(r, c);
        ...
        try {
            ...
            if (cell.resolved()) {
                throw WriteFailureOnLockedCsmElement("Csm::set: write to locked element");
            }
