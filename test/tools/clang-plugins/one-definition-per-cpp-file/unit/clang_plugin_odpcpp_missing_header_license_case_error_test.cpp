/**
 * @file clang_plugin_odpcpp_missing_header_license_case_error_test.cpp
 * @brief License case mismatch should error.
 */
 ...
 * @name ClangPluginODPCPP.MissingHeaderLicenseCaseFails
...
TEST(ClangPluginODPCPP, MissingHeaderLicenseCaseFails) {
    std::string log;
