/**
 * @file clang_plugin_odpcpp_missing_header_copyright_error_test.cpp
 * @brief Missing copyright in header should error.
 */
 ...
 * @name ClangPluginODPCPP.MissingHeaderCopyrightFails
...
TEST(ClangPluginODPCPP, MissingHeaderCopyrightFails) {
    std::string log;
    ...
    const auto fixture =
            ...
            "sad/missing_header_copyright/src/MissingHeaderCopyright.cpp";
