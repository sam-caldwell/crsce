/**
 * @file clang_plugin_odph_happy_enum_test.cpp
 * @brief OneDefinitionPerHeader: happy enum passes.
 */
 ...
 * @name ClangPluginODPH.HappyEnumPasses
...
TEST(ClangPluginODPH, HappyEnumPasses) {
    std::string log;
    ...
    const auto fixture = repo / "test/tools/clang-plugins/OneDefinitionPerHeader/"
                         "fixtures/happy/include/HappyEnum.h";
