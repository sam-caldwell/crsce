/**
 * @file clang_plugin_odph_missing_header_author_case_error_test.cpp
 * @brief Header doc uses lowercase author; should fail.
 */
 ...
 * @name ClangPluginODPH.MissingHeaderAuthorCaseFails
...
TEST(ClangPluginODPH, MissingHeaderAuthorCaseFails) {
    std::string log;
    ...
    const auto fixture =
            ...
            "missing_header_author_case/include/MissingHeaderAuthorCase.h";
    ASSERT_TRUE(std::filesystem::exists(fixture));

    std::string out;
    const int code = clang_compile_with_plugin(fixture, lib, out);
    EXPECT_NE(code, 0) << "Expected failure for wrong-case author\n" << out;
