/**
 * @file clang_plugin_odph_missing_typedef_doc_error_test.cpp
 * @brief ODPH: missing typedef doc should fail.
 */
 ...
 * @name ClangPluginODPH.MissingTypedefDocFails
...
TEST(ClangPluginODPH, MissingTypedefDocFails) {
    std::string log;
    ...
    const auto fixture = repo / "test/tools/clang-plugins/OneDefinitionPerHeader/"
                         "fixtures/sad/missing_construct_doc_typedef/include/MissingTypedefDoc.h";
