/**
 * @file clang_plugin_odph_happy_alias_test.cpp
 * @brief ODPH: alias happy path passes.
 */
 ...
 * @name ClangPluginODPH.HappyAliasPasses
...
TEST(ClangPluginODPH, HappyAliasPasses) {
    std::string log;
    ...
    const auto fixture = repo / "test/tools/clang-plugins/OneDefinitionPerHeader/"
                         "fixtures/happy/include/HappyAlias.h";
