...
int main() try {
    ...
    if (o11y_on) {
        ::crsce::o11y::metric("testrunner_begin", 1LL, {{"runner", std::string("testRunnerZeroes")}});
    ...
    if (o11y_on) {
        ...
        else { ::crsce::o11y::event("testrunner_error", {{"runner", std::string("testRunnerZeroes")}, {"type", std::string("nonzero_rc")}}); ::crsce::o11y::counter("testrunner_runs_failed"); }
        ::crsce::o11y::metric("testrunner_end", 1LL, {{"runner", std::string("testRunnerZeroes")}, {"status", (rc==0?std::string("OK"):std::string("FAIL"))}});
    }
    return rc;
    ...
    if (const char *p = std::getenv("CRSCE_TESTRUNNER_O11Y") /* NOLINT(concurrency-mt-unsafe) */; p && *p && *p!='0') {
        ::crsce::o11y::event("testrunner_error", {{"runner", std::string("testRunnerZeroes")}, {"type", std::string("decompress_exception")}});
        ::crsce::o11y::counter("testrunner_runs_failed");
        ::crsce::o11y::metric("testrunner_end", 1LL, {{"runner", std::string("testRunnerZeroes")}, {"status", std::string("FAIL")}});
    }
    std::cout << "{\n"
              << "  \"step\":\"error\",\n"
    ...
    if (const char *p = std::getenv("CRSCE_TESTRUNNER_O11Y") /* NOLINT(concurrency-mt-unsafe) */; p && *p && *p!='0') {
        ::crsce::o11y::event("testrunner_error", {{"runner", std::string("testRunnerZeroes")}, {"type", std::string("compress_exception")}});
        ::crsce::o11y::counter("testrunner_runs_failed");
        ::crsce::o11y::metric("testrunner_end", 1LL, {{"runner", std::string("testRunnerZeroes")}, {"status", std::string("FAIL")}});
    }
    if (const char *p = std::getenv("CRSCE_TESTRUNNER_O11Y") /* NOLINT(concurrency-mt-unsafe) */; p && *p && *p!='0') {
        ::crsce::o11y::event("testrunner_error", {{"runner", std::string("testRunnerZeroes")}, {"type", std::string("std_exception")}});
        ::crsce::o11y::counter("testrunner_runs_failed");
        ::crsce::o11y::metric("testrunner_end", 1LL, {{"runner", std::string("testRunnerZeroes")}, {"status", std::string("FAIL")}});
    }
    std::cout << "{\n"
    ...
    if (const char *p = std::getenv("CRSCE_TESTRUNNER_O11Y") /* NOLINT(concurrency-mt-unsafe) */; p && *p && *p!='0') {
        ::crsce::o11y::event("testrunner_error", {{"runner", std::string("testRunnerZeroes")}, {"type", std::string("unknown_exception")}});
        ::crsce::o11y::counter("testrunner_runs_failed");
        ::crsce::o11y::metric("testrunner_end", 1LL, {{"runner", std::string("testRunnerZeroes")}, {"status", std::string("FAIL")}});
    }
    std::cout << "{\n"
