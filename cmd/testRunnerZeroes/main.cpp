...
int main() try {
    ...
    ::crsce::o11y::O11y::instance().event("testrunner_begin", {{"runner", std::string("testRunnerZeroes")}});
    ...
    ::crsce::o11y::O11y::instance().event("testrunner_end", {{"runner", std::string("testRunnerZeroes")}, {"status", (rc==0?std::string("OK"):std::string("FAIL"))}});
    return rc;
    ...
    ::crsce::o11y::O11y::instance().event("testrunner_end", {{"runner", std::string("testRunnerZeroes")}, {"status", std::string("FAIL")}});
    std::cout << "{\n"
              << "  \"step\":\"error\",\n"
